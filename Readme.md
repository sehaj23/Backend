...
### database.ts
```typescript    
dev_uri = `mongodb+srv://zattire_dev:zattire_dev_password@production.8kbli.mongodb.net/zattire_pro?authSource=admin&replicaSet=atlas-27r88k-shard-0&w=majority&readPreference=primary&appname=MongoDB%20Compass&retryWrites=true&ssl=true`
prod_uri = ``
```
